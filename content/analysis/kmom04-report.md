...
De främsta färgerna som används på denna sida:
<table style="border-spacing: 4px; border-collapse: separate">
<tr>
<td style="height: 50px; width: 50px; background-color: #ec7">
<td style="height: 50px; width: 50px; background-color: #1ce">
<td style="height: 50px; width: 50px; background-color: #529">
</tr>
</table>
<img src="../assets/img/lol_screenshot1.png" width="1000" height="500" alt="Bild av league of legends hemsida" />
...
<table style="border-spacing: 4px; border-collapse: separate">
<tr>
<td style="height: 50px; width: 50px; background-color: #dfe">
<td style="height: 50px; width: 50px; background-color: #def">
<td style="height: 50px; width: 50px; background-color: #edf">
</tr>
</table>
<img src="../assets/img/wikipedia_screenshot.png" width="1000" height="500" alt="Bild av Wikipedias hemsida" />
...
<table style="border-spacing: 4px; border-collapse: separate">
<tr>
<td style="height: 50px; width: 50px; background-color: #f86">
<td style="height: 50px; width: 50px; background-color: #d14">
<td style="height: 50px; width: 50px; background-color: #bfe">
</tr>
</table>
<img src="../assets/img/asos_screenshot.png" width="1000" height="500" alt="Bild av Asos hemsida" />
